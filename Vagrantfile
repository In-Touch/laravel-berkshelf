...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_url = "https://s3.amazonaws.com/intouch-tools/precise64-chef11.box"
  ...
  config.vm.provision :chef_solo do |chef|
    chef.json = {
      'laravel-berkshelf' => {
        ...
        :hostname => 'laravel-berkshelf.local',
        :aliases => ['*.laravel-berkshelf.local'],
        :app_env => 'local',
        :owner => 'vagrant',
        :group => 'vagrant'
      },
    ...
    chef.run_list = [
        "recipe[laravel-berkshelf::default]"
    ]
  end
end
